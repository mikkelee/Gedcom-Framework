...
* **tags.json**: Currently only partially done (but is able to read a real-world example generated by GEDitCOM II as well as a slightly modified version of allged.ged).
