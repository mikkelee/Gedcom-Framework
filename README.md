...
* **GCDate**: Convert ParseKit parser to Ragel state machine to get rid of dependency, clean up class cluster internals. Ultimately Gedcom.framework should only depend on Foundation.framework
