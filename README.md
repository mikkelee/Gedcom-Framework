...
**Note**: Functionality is there, so I am now tagging as 0.9 -- 1.0 comes after a bit more thorough testing/bugsquashing + better documentation.
...
* **tags.json**: 95% done (is able to losslessly handle a real-world example generated by GEDitCOM II, simple.ged, as well as a slightly modified version of allged.ged; can handle TGC55.ged but refuses to validate it).
