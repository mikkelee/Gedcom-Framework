...
@implementation NSString (MEJaroWinklerAdditions)

- (double)jaroWinklerDistanceToString:(NSString *)string
{
    const char *ying = [self cStringUsingEncoding:NSUTF8StringEncoding];
    const char *yang = [string cStringUsingEncoding:NSUTF8StringEncoding];
    int opts[] = {0,0};
