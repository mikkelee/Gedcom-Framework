...
- (void)setTypeDescription:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			...
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setTypeDescription:_typeDescription];
...
- (void)setDate:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setDate:_date];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setPlace:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setPlace:_place];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setAddress:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setAddress:_address];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setPhoneNumber:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setPhoneNumber:_phoneNumber];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setAge:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setAge:_age];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setResponsibleAgency:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setResponsibleAgency:_responsibleAgency];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setCause:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setCause:_cause];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inSourceCitationsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromSourceCitationsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromSourceCitationsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_sourceCitations[idx] inSourceCitationsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inSourceEmbeddedsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromSourceEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromSourceEmbeddedsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_sourceEmbeddeds[idx] inSourceEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inMultimediaReferencesAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromMultimediaReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromMultimediaReferencesAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_multimediaReferences[idx] inMultimediaReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inMultimediaEmbeddedsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromMultimediaEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromMultimediaEmbeddedsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_multimediaEmbeddeds[idx] inMultimediaEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inNoteReferencesAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromNoteReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromNoteReferencesAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_noteReferences[idx] inNoteReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inNoteEmbeddedsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromNoteEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromNoteEmbeddedsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_noteEmbeddeds[idx] inNoteEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setHusbandDetail:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setHusbandDetail:_husbandDetail];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
	...
	if (_husbandDetail) {
		[(id)_husbandDetail setValue:nil forKey:@"describedObject"];
	}
...
- (void)setWifeDetail:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCFamilyEventAttribute *)[uM prepareWithInvocationTarget:self] setWifeDetail:_wifeDetail];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
	...
	if (_wifeDetail) {
		[(id)_wifeDetail setValue:nil forKey:@"describedObject"];
	}
