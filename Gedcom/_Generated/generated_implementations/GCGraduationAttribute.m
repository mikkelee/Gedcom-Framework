...
- (void)setTypeDescription:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setTypeDescription:_typeDescription];
...
- (void)setDate:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setDate:_date];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setPlace:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setPlace:_place];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setAddress:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setAddress:_address];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setPhoneNumber:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setPhoneNumber:_phoneNumber];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setAge:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setAge:_age];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setResponsibleAgency:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setResponsibleAgency:_responsibleAgency];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setCause:(id)obj
{
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setCause:_cause];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inSourceCitationsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceCitationsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromSourceCitationsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_sourceCitations[index] inSourceCitationsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inSourceEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromSourceEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_sourceEmbeddeds[index] inSourceEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inMultimediaReferencesAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaReferencesAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromMultimediaReferencesAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaReferences[index] inMultimediaReferencesAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaEmbeddeds[index] inMultimediaEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inNoteReferencesAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteReferencesAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromNoteReferencesAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_noteReferences[index] inNoteReferencesAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)insertObject:(id)obj inNoteEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)removeObjectFromNoteEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCGraduationAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_noteEmbeddeds[index] inNoteEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
