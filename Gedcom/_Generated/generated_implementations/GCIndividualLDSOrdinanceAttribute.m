...
- (void)setDate:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			...
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] setDate:_date];
...
- (void)setTemple:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] setTemple:_temple];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)setPlace:(id)obj
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] setPlace:_place];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inSourceCitationsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromSourceCitationsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromSourceCitationsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_sourceCitations[idx] inSourceCitationsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inSourceEmbeddedsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromSourceEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromSourceEmbeddedsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_sourceEmbeddeds[idx] inSourceEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inNoteReferencesAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromNoteReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromNoteReferencesAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_noteReferences[idx] inNoteReferencesAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)insertObject:(id)obj inNoteEmbeddedsAtIndex:(NSUInteger)idx
{
	...
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] removeObjectFromNoteEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
...
- (void)removeObjectFromNoteEmbeddedsAtIndex:(NSUInteger)idx
{
	if (!_isBuildingFromGedcom) {
		...
		@synchronized (uM) {
			[uM beginUndoGrouping];
			[(GCIndividualLDSOrdinanceAttribute *)[uM prepareWithInvocationTarget:self] insertObject:_noteEmbeddeds[idx] inNoteEmbeddedsAtIndex:idx];
			[uM setActionName:[NSString stringWithFormat:GCLocalizedString(@"Undo %@", @"Misc"), self.localizedType]];
			[uM endUndoGrouping];
		}
	}
