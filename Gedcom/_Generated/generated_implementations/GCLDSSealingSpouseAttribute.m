...
- (void)setLDSSealingSpouseStatus:(id)obj
{
	...
	[(GCLDSSealingSpouseAttribute *)[self.undoManager prepareWithInvocationTarget:self] setLDSSealingSpouseStatus:_lDSSealingSpouseStatus];
...
- (void)setDate:(id)obj
{
	...
	[(GCLDSSealingSpouseAttribute *)[self.undoManager prepareWithInvocationTarget:self] setDate:_date];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setTemple:(id)obj
{
	...
	[(GCLDSSealingSpouseAttribute *)[self.undoManager prepareWithInvocationTarget:self] setTemple:_temple];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
...
- (void)setPlace:(id)obj
{
	...
	[(GCLDSSealingSpouseAttribute *)[self.undoManager prepareWithInvocationTarget:self] setPlace:_place];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, typeName]];
