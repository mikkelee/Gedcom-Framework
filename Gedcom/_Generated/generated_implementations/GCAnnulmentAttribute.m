...
- (void)setTypeDescription:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setTypeDescription:_typeDescription];
...
- (void)setDate:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setDate:_date];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setPlace:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setPlace:_place];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setAddress:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setAddress:_address];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setPhoneNumber:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setPhoneNumber:_phoneNumber];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setAge:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setAge:_age];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setResponsibleAgency:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setResponsibleAgency:_responsibleAgency];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setCause:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setCause:_cause];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inSourceCitationsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceCitationsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromSourceCitationsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_sourceCitations[index] inSourceCitationsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inSourceEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromSourceEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_sourceEmbeddeds[index] inSourceEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inMultimediaReferencesAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaReferencesAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromMultimediaReferencesAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaReferences[index] inMultimediaReferencesAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaEmbeddeds[index] inMultimediaEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inNoteReferencesAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteReferencesAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromNoteReferencesAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_noteReferences[index] inNoteReferencesAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)insertObject:(id)obj inNoteEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)removeObjectFromNoteEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] insertObject:_noteEmbeddeds[index] inNoteEmbeddedsAtIndex:index];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setHusbandDetail:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setHusbandDetail:_husbandDetail];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
...
- (void)setWifeDetail:(id)obj
{
	...
	[(GCAnnulmentAttribute *)[self.undoManager prepareWithInvocationTarget:self] setWifeDetail:_wifeDetail];
	[self.undoManager setActionName:[NSString stringWithFormat:formatString, self.localizedType]];
