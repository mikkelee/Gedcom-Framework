...
- (void)setChildInFamily:(GCProperty *)obj
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setChildInFamily:_childInFamily];
	[self.context.undoManager setActionName:@"Undo childInFamily"]; //TODO
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setTypeDescription:_typeDescription];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setDate:_date];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setPlace:_place];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setAddress:_address];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setPhoneNumber:_phoneNumber];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setAge:_age];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setResponsibleAgency:_responsibleAgency];
...
{
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] setCause:_cause];
...
- (void)insertObject:(GCProperty *)obj inSourceCitationsAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceCitationsAtIndex:index];
...
- (void)removeObjectFromSourceCitationsAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_sourceCitations[index] inSourceCitationsAtIndex:index];
	[self.context.undoManager setActionName:@"Undo sourceCitations"]; //TODO
...
- (void)insertObject:(GCProperty *)obj inSourceEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromSourceEmbeddedsAtIndex:index];
...
- (void)removeObjectFromSourceEmbeddedsAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_sourceEmbeddeds[index] inSourceEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:@"Undo sourceEmbeddeds"]; //TODO
...
- (void)insertObject:(GCProperty *)obj inMultimediaReferencesAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaReferencesAtIndex:index];
...
- (void)removeObjectFromMultimediaReferencesAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaReferences[index] inMultimediaReferencesAtIndex:index];
	[self.context.undoManager setActionName:@"Undo multimediaReferences"]; //TODO
...
- (void)insertObject:(GCProperty *)obj inMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromMultimediaEmbeddedsAtIndex:index];
...
- (void)removeObjectFromMultimediaEmbeddedsAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_multimediaEmbeddeds[index] inMultimediaEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:@"Undo multimediaEmbeddeds"]; //TODO
...
- (void)insertObject:(GCProperty *)obj inNoteReferencesAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteReferencesAtIndex:index];
...
- (void)removeObjectFromNoteReferencesAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_noteReferences[index] inNoteReferencesAtIndex:index];
	[self.context.undoManager setActionName:@"Undo noteReferences"]; //TODO
...
- (void)insertObject:(GCProperty *)obj inNoteEmbeddedsAtIndex:(NSUInteger)index {
	...
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] removeObjectFromNoteEmbeddedsAtIndex:index];
...
- (void)removeObjectFromNoteEmbeddedsAtIndex:(NSUInteger)index {
	[(GCChristeningAttribute *)[self.context.undoManager prepareWithInvocationTarget:self] insertObject:_noteEmbeddeds[index] inNoteEmbeddedsAtIndex:index];
	[self.context.undoManager setActionName:@"Undo noteEmbeddeds"]; //TODO
