...
{
	GCDate *result = [GCDate dateFromGedcom:@"05 12 1831"];
...
-(void)testSimpleDate
{
	GCDate *result = [GCDate dateFromGedcom:@"FEB 1765"];
...
{
	GCDate *result = [GCDate dateFromGedcom:@"ABT 12 JAN 1900"];
...
{
	GCDate *result = [GCDate dateFromGedcom:@"INT 4 MAR 1799 (guesstimate)"];
...
-(void)testDatePeriod
{
	GCDate *result = [GCDate dateFromGedcom:@"FROM JUN 1920 TO 12 AUG 1935"];
...
-(void)testDateRange
{
	GCDate *result = [GCDate dateFromGedcom:@"BET 1840 AND 1845"];
...
-(void)testDatePhrase
{
	GCDate *result = [GCDate dateFromGedcom:@"(Dato ukendt)"];
